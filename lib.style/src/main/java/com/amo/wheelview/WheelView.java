...
import com.aiyiqi.decoration.lib.style.R;
...
public class WheelView extends View {
	...
	private static final int VALUE_TEXT_COLOR = 0xF0282828;
	...
	public int CURRENT_ITEM_TEXT_SIZE;
	...
	private void initData(Context context) {
		ADDITIONAL_ITEM_HEIGHT = (int) (ADDITIONAL_ITEM_HEIGHT * getResources().getDisplayMetrics().density);
	...
	private void initResourcesIfNecessary() {
		...
		if(labelPaint == null){
			...
			labelPaint.setColor(Color.parseColor("#282828"));
			//labelPaint.setShadowLayer(0.1f, 0, 0.1f, 0xFF282828);
		}

		if(currentValuePaint == null){
			currentValuePaint = new TextPaint(Paint.ANTI_ALIAS_FLAG |Paint.FAKE_BOLD_TEXT_FLAG | Paint.DITHER_FLAG);
			// valuePaint.density = getResources().getDisplayMetrics().density;
			currentValuePaint.setTextSize(CURRENT_ITEM_TEXT_SIZE);
			currentValuePaint.setColor(Color.parseColor("#282828"));
		}

		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(
					R.drawable.lib_style_wheel_val);
		}
